...
import type { CustomCategory as _CustomCategory, ExternalBlob as _ExternalBlob, NoteMetaData as _NoteMetaData, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addBookmark(arg0: string): Promise<boolean> {
        if (this.processError) {
            try {
    ...
    async createNote(arg0: NoteMetaData): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createNote(await to_candid_NoteMetaData_n10(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createOrUpdateProfile(arg0: string, arg1: bigint, arg2: string, arg3: CustomCategory): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createOrUpdateProfile(arg0, arg1, arg2, to_candid_CustomCategory_n13(this._uploadFile, this._downloadFile, arg3));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllNotes(): Promise<Array<NoteMetaData>> {
        if (this.processError) {
            try {
    ...
    async getBookmarkedNotes(): Promise<Array<NoteMetaData>> {
        if (this.processError) {
            try {
    ...
    async getFeaturedNotes(): Promise<Array<NoteMetaData>> {
        if (this.processError) {
            try {
                const result = await this.actor.getFeaturedNotes();
                return from_candid_vec_n15(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getNoteById(arg0: string): Promise<NoteMetaData | null> {
        if (this.processError) {
            try {
    ...
    async getNotesByCategory(arg0: CustomCategory): Promise<Array<NoteMetaData>> {
        if (this.processError) {
            try {
                const result = await this.actor.getNotesByCategory(to_candid_CustomCategory_n13(this._uploadFile, this._downloadFile, arg0));
                return from_candid_vec_n15(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getRecentNotes(): Promise<Array<NoteMetaData>> {
        if (this.processError) {
            try {
                const result = await this.actor.getRecentNotes();
                return from_candid_vec_n15(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getUserNotes(arg0: Principal): Promise<Array<NoteMetaData>> {
        if (this.processError) {
            try {
                const result = await this.actor.getUserNotes(arg0);
                return from_candid_vec_n15(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateNote(arg0: string, arg1: NoteMetaData): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateNote(arg0, await to_candid_NoteMetaData_n10(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_CustomCategory_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _CustomCategory): CustomCategory {
...
async function from_candid_NoteMetaData_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _NoteMetaData): Promise<NoteMetaData> {
...
async function from_candid_opt_n26(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_NoteMetaData]): Promise<NoteMetaData | null> {
    return value.length === 0 ? null : await from_candid_NoteMetaData_n16(_uploadFile, _downloadFile, value[0]);
}
...
async function from_candid_record_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        category: from_candid_CustomCategory_n19(_uploadFile, _downloadFile, value.category),
...
function from_candid_record_n23(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        dob: value.dob,
        name: value.name,
        course: from_candid_CustomCategory_n19(_uploadFile, _downloadFile, value.course)
    };
}
...
function from_candid_variant_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "graduate" in value ? CustomCategory.graduate : "dPharm" in value ? CustomCategory.dPharm : "bPharm" in value ? CustomCategory.bPharm : "mPharm" in value ? CustomCategory.mPharm : value;
}
...
async function from_candid_vec_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_NoteMetaData>): Promise<Array<NoteMetaData>> {
    return await Promise.all(value.map(async (x)=>await from_candid_NoteMetaData_n16(_uploadFile, _downloadFile, x)));
}
function to_candid_CustomCategory_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: CustomCategory): _CustomCategory {
...
async function to_candid_NoteMetaData_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: NoteMetaData): Promise<_NoteMetaData> {
...
async function to_candid_record_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        isFeatured: value.isFeatured,
        timestamp: value.timestamp,
        category: to_candid_CustomCategory_n13(_uploadFile, _downloadFile, value.category),
        uploader: value.uploader,
        isPublic: value.isPublic
    };
}
function to_candid_record_n28(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        dob: value.dob,
        name: value.name,
        course: to_candid_CustomCategory_n13(_uploadFile, _downloadFile, value.course)
    };
}
...
function to_candid_variant_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: CustomCategory): {
    graduate: null;
} | {
    dPharm: null;
} | {
    ...
    return value == CustomCategory.graduate ? {
        graduate: null
    } : value == CustomCategory.dPharm ? {
        dPharm: null
    } : value == CustomCategory.bPharm ? {
        bPharm: null
    } : value == CustomCategory.mPharm ? {
        mPharm: null
    } : value;
}
